...
<body>
  ...
  <section id="mission" class="section">
    <div class="container">
      <h2 class="section-title"><center>🍵 MISSION</center></h2>
      <p>
        Our mission is to bridge tradition and technology by turning $DIM into the official payment of dim sum houses worldwide.<br/>
        We aim to:<br/>
